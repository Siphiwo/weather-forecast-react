...
function App() {
  ...
  const [weatherIcon, setWeatherIcon] = useState('https://s3-us-west-2.amazonaws.com/s.cdpn.io/162656/10n.svg')
  ...
  const getWeather = (location) => {
   ...
   fetch(`https://api.openweathermap.org/data/2.5/forecast?${how_to_search}&appid=${API_KEY}&units=metric&cnt=5&exclude=hourly,minutely`)
      ...
      <div className="flex w-3/4 min-h-full rounded-3xl shadow-lg m-auto bg-gray-100">
        ...
        <div className="form-container">
          <div className="flex items-center justify-center">
            ...
            <i className="fa fa-map-marker-alt my-auto" aria-hidden="true"></i>
          ...
          <div className="flex flex-col items-center justify-center h-full">
            ...
            <form noValidate onSubmit={handleSubmit} className="flex justify-center w-full">
              ...
              <i className="fa fa-location-arrow my-auto cursor-pointer p-3 text-white" aria-hidden="true" onClick={() => {
          ...
          <div className="flex flex-col my-10">
            ...
            {weatherData.length === 0 ? 
              <div className="container p-4 flex items-center justify-center h-1/3 mb-auto">
                <h1 className="text-gray-300 text-4xl font-bold uppercase">No Data Yet</h1>
              </div> :
              <>
